...
from . import configuration,  observation, telescopes, websocket, observatories, cameras, filter_wheels, status, dark, focuser
...
api_router.include_router(dark.router)
api_router.include_router(focuser.router)