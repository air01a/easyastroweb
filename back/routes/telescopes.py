...
from services.config import save_telescope_config, get_telescope_config, get_telescope_config_schema, set_default_telescope_config, CONFIG, TELESCOPE_PATH, TELESCOPE_SCHEMA_PATH
