...
from services.config import CONFIG, CONFIG_SCHEME, save_config as root_save_config, load_config_async, get_observatory as root_observatory, get_observatory_schema as root_observatory_schema
