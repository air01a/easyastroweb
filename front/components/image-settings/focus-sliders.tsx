...
export default function FocusSlider({ onUpdate, loopEnable }: { onUpdate: () => void , loopEnable: (value: boolean) => void }) {
    ...
    <div className="space-y-4 p-4 w-[50%] min-w-100 bg-gray-900 text-white rounded-xl shadow">
      <div>
        ...
        {isFocuserConnected && (
          <div>
            <div className="flex flex-wrap justify-center items-center mb-4">
              <Button disabled={isMoving} className="mr-4" onClick={() => handlePositionChange(position - step)}>
                <ArrowBigLeft />
              </Button>
              <Button
                disabled={isMoving}
        ...
        <div className="flex items-center justify-center gap-4 mt-4">
          <Button onClick={handleMainButton} disabled={isMoving}>
